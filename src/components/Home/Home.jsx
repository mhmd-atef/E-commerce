...
import HomeSilder from "../HomeSlider/HomeSlider";
        ...
        <div className="row m-4  gx-0">
          ...
          <div className="col-sm-3">
            <img
              ...
              src={require("../../Assets/images/pngaaa.png")}
              alt="slider"
            />
            <img
              style={{ width: "100%", height: "200px" }}
                ...
                <div className="product zbo p-3">
                  <Link to={`/Detailes/${product.id}`}>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      <h6>
                        <span className="main-color">{product.price}</span> EGP
                      </h6>
                      <h6>
                        {" "}
                        <span>
